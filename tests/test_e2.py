...
def test_get_e2():
    ...
    e2_expected = e2_expected.at[2].set(jnp.sin(theta[0]) * jnp.sin(theta[1]) * jnp.cos(theta[2]))
    e2_expected = e2_expected.at[3].set(jnp.sin(theta[0]) * jnp.sin(theta[1]) * jnp.sin(theta[2]) * jnp.cos(theta[3]))
    e2_expected = e2_expected.at[4].set(jnp.sin(theta[0]) * jnp.sin(theta[1]) * jnp.sin(theta[2]) * jnp.sin(theta[3]))
